...
num_elements= len(dataset)-1
num_folds=10
for i in range(0,num_folds):
    first_index=int((i*elements/float(num_folds)))
    second_index=int(((i+1)*elements/float(num_folds)))
    train_x = reshaped_segments[:first_index]+reshaped_segments[second_index:]
    train_y = labels[:first_index]+labels[second_index:]
    test_x = reshaped_segments[first_index:second_index]
    test_y = labels[first_index:second_index]
